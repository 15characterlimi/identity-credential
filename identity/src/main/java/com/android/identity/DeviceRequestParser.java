...
public final class DeviceRequestParser {
     ...
     */
    @NonNull
    public DeviceRequestParser setDeviceRequest(@NonNull byte[] encodedDeviceRequest) {
     ...
     */
    @NonNull
    public DeviceRequestParser setSessionTranscript(
    ...
    public static final class DocumentRequest {
         ...
         */
        @NonNull
        public List<String> getEntryNames(@NonNull String namespaceName) {
